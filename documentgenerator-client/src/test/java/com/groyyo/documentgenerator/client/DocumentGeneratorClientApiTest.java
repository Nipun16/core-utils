...
import com.groyyo.documentgenerator.client.api.DocumentGeneratorClientApi;
...
public class DocumentGeneratorClientApiTest {
	...
	GroyyoRestClient groyyoRestClient = null;
	...
	public void setupData() {
		groyyoRestClient = new GroyyoRestClient("http://localhost:8086/documentgenerator");
		clientApi = new DocumentGeneratorClientApi(groyyoRestClient);
	...
	public void test_GeneratePdf_FTL_TemplateType() {
		...
		// assertEquals("https://dev-mail-templates-erp.s3.ap-south-1.amazonaws.com/template_groyyo_ftl_test.pdf",
