package com.groyyo.documentgenerator.client;

import java.util.Arrays;
import java.util.HashMap;
import java.util.Map;

import com.groyyo.documentgenerator.dto.DocumentDto;
import com.groyyo.documentgenerator.dto.DocumentGeneratorTemplateRequestDto;
import com.groyyo.documentgenerator.dto.PdfDocumentDto;
import com.groyyo.documentgenerator.dto.PdfRequestDto;
import com.groyyo.documentgenerator.enums.DocumentGeneratorTemplateType;
...
public class DocumentGeneratorData {
	...
	public static DocumentGeneratorTemplateRequestDto getHTMLTemplateDto() {
		...
		templateRequestDto.setTemplateName("template_groyyo_html");
		...
		modelData.put("image",
				"https://res.cloudinary.com/groyyo-living/image/upload/q_60,w_1000/v1554802583/Website/Residences/Boston/1.jpg");
	...
	public static DocumentGeneratorTemplateRequestDto getFTLTemplateDto() {
		...
		DocumentGeneratorTemplateRequestDto templateRequestDto = new DocumentGeneratorTemplateRequestDto();
		templateRequestDto.setTemplateName("template_groyyo_ftl");
	...
	public static PdfRequestDto getPdfDocumentDtoFTLTemplateType() {
		...
		DocumentDto documentDto = DocumentDto.builder().documentOutputFileName("template_groyyo_ftl_test")
		...
		DocumentGeneratorTemplateRequestDto templateRequestDto = DocumentGeneratorTemplateRequestDto.builder()
				.templateName("template_groyyo_ftl").templateType(DocumentGeneratorTemplateType.TYPE_FTL.getName())
	...
	public static PdfRequestDto getPdfDocumentDtoHTMLTemplateType() {
		DocumentDto documentDto = DocumentDto.builder().documentOutputFileName("template_groyyo_html_test")
		...
		DocumentGeneratorTemplateRequestDto templateRequestDto = DocumentGeneratorTemplateRequestDto.builder()
				.templateName("template_groyyo_html").templateType(DocumentGeneratorTemplateType.TYPE_HTML.getName())
				.templateModelData(modelData).build();
