...
import com.groyyo.core.utilservice.annotations.AllowedStringList;
...
public class NotEmptyFieldsValidator implements ConstraintValidator<AllowedStringList, List<String>> {
    ...
    public boolean isValid(List<String> values, ConstraintValidatorContext context) {
        ...
        if(values.size() == 0){
            throw new GroyyoException("List should have atleast one element");
        }
        else {
