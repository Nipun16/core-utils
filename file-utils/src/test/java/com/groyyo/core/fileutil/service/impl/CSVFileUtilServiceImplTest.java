package com.groyyo.core.fileutil.service.impl;

import com.amazonaws.services.s3.AmazonS3;
import com.amazonaws.services.s3.model.GetObjectRequest;
import com.amazonaws.services.s3.model.S3Object;
import com.groyyo.core.amazons3.service.S3DownloadService;
import com.groyyo.core.amazons3.service.S3UploadService;
import com.groyyo.core.base.exception.GroyyoException;
import com.groyyo.core.fileutil.dto.CSVResponse;
import com.groyyo.core.fileutil.dto.S3UploadResponse;
import com.groyyo.core.fileutil.testdata.GlobalTestData;
...
import static com.groyyo.core.fileutil.testdata.GlobalTestData.getInvalidMultipartFile;
import static com.groyyo.core.fileutil.testdata.GlobalTestData.getSampleMultipartFile;
...
class CSVFileUtilServiceImplTest {
    ...
    void readInputStreamCSVFileTest() throws Exception {
        ...
        InputStream actual = csvFileUtilService.retrieveFile("groyyo-test-bucket", "agreement_2021-04-12T03:35:58Z_sample_2021-02-04 (1).csv", client);
    ...
    void readCSVFileTest() throws Exception {
        ...
        s3Object.setObjectContent(GlobalTestData.getSampleMultipartFile().getInputStream());
        when(amazonS3.getObject(any(GetObjectRequest.class))).thenReturn(s3Object);
        CSVResponse actualResponse = csvFileUtilService.readCSVFile("groyyo-test-bucket", "agreement_2021-04-12T03:35:58Z_sample_2021-02-04 (1).csv", client);
        assertAll(
                () -> assertEquals(expectedResponse.getHeader(), actualResponse.getHeader()),
                () -> assertEquals(expectedResponse.getData(), actualResponse.getData()),
                () -> assertEquals(expectedResponse.getFilterHeader(), actualResponse.getFilterHeader()),
    ...
    void getPreSignedURLTest() {
        ...
        String actualOutput = csvFileUtilService.getPreSignedURL("groyyo-test-bucket","agreement_2021-04-12T03:35:58Z_sample_2021-02-04 (1).csv", 60, client);
    ...
    void uploadTest() throws Exception {
        ...
        S3UploadResponse actualResponse = csvFileUtilService.upload("groyyo-test-bucket", "agreement_2021-04-12T03:35:58Z_sample_2021-02-04 (1).csv",
    ...
    void uploadInvalidCaseTest() throws Exception {
        ...
        AmazonS3 client = GlobalTestData.getSampleAmazonS3();
        assertThatThrownBy(() -> csvFileUtilService.upload("groyyo-test-bucket",
                "agreement_2021-04-12T03:35:58Z_sample_2021-02-04 (1).csv",
                "sample_2021-02-04 (1).csv",
                file.getInputStream(), file.getContentType(),client, false))
                .isInstanceOf(GroyyoException.class)
