package com.groyyo.core.erp.supplychain.enums;

import com.groyyo.core.erp.supplychain.dto.SmsInfo;
...
public enum SupplyChainEvents {
    ...
    static {
        ...
        scDltTemplateMap.put(PO_APPROVAL, new SmsInfo("1707165813001183916","PARTNER", "A new Purchase Order has been raised by Groyyo Living. Please login here to accept the purchase order: <url>"));
        scDltTemplateMap.put(VENDOR_ACCEPTED, new SmsInfo("1707165820435842841","SL", "Purchase order <poNumber> has been accepted by Groyyo Living Partner <companyName>. Click here for the next steps: <url>"));
        scDltTemplateMap.put(VENDOR_REJECTED, new SmsInfo("1707165820437664749","SL", "Purchase Order <poNumber> has been rejected by Groyyo Living partner <companyName>. Click here: <url> to know the details."));
        scDltTemplateMap.put(PO_CANCELLED, new SmsInfo("1707165820440339977","PARTNER", "Purchase order <poNumber> has been canceled by Groyyo Living. For further information, please check here: <url>"));
        scDltTemplateMap.put(PO_SHORTCLOSE_SUBMIT, new SmsInfo("1707165820442446737","SL", "Groyyo Living Partner<companyName> has requested to short close purchase order <poNumber>. To know more, click here: <url>"));
        scDltTemplateMap.put(GSRI_COMPLETED, new SmsInfo("1707165813021585699","PARTNER", "<grnPercentage>% of GRN for purchase order <poNumber> has been received at Groyyo Living. Kindly login to see the details. Click here to know more: <url>"));
        scDltTemplateMap.put(REG_INV_SUBMITTED, new SmsInfo("1707165820444349249","SL", "Invoice <invoiceNumber> has been submitted by <companyName> for Groyyo Living. Click here to know the details: <url>"));
        scDltTemplateMap.put(REG_INV_REJECTED, new SmsInfo("1707165813030073866","PARTNER", "Your invoice <invoiceNumber> has been rejected by Groyyo Living. Kindly login to know the reason: <url>"));
        scDltTemplateMap.put(REG_INV_PAYMENT, new SmsInfo("1707165813033770944","SL", "Payment of Rs.<amountPaid> has been made against your invoice no. <invoiceNumber> by Groyyo Living. To see the details, please click here: <url>"));
        scDltTemplateMap.put(GSRI_INSTALL, new SmsInfo("1707165813021585699","PARTNER", "<grnPercentage>% of GRN for purchase order <poNumber> has been received at Groyyo Living. Kindly login to see the details. Click here to know more: <url>"));
        scDltTemplateMap.put(ADV_INV_SUBMITTED, new SmsInfo("1707165820444349249","SL", "Invoice <invoiceNumber> has been submitted by <companyName> for Groyyo Living. Click here to know the details: <url>"));
        scDltTemplateMap.put(ADV_INV_REJECTED, new SmsInfo("1707165813030073866","PARTNER", "Your invoice <invoiceNumber> has been rejected by Groyyo Living. Kindly login to know the reason: <url>"));
        scDltTemplateMap.put(ADV_PAYMENT, new SmsInfo("1707165813033770944","SL", "Payment of Rs.<amountPaid> has been made against your invoice no. <invoiceNumber> by Groyyo Living. To see the details, please click here: <url>"));
        scDltTemplateMap.put(REG_INV_PAYMENT_COMPLETE, new SmsInfo("1707165813033770944","SL", "Payment of Rs.<amountPaid> has been made against your invoice no. <invoiceNumber> by Groyyo Living. To see the details, please click here: <url>"));
        scDltTemplateMap.put(ADV_PAYMENT_COMPLETE, new SmsInfo("1707165813033770944","SL", "Payment of Rs.<amountPaid> has been made against your invoice no. <invoiceNumber> by Groyyo Living. To see the details, please click here: <url>"));
