...
import com.groyyo.core.user.acl.dto.UserAccessLevelIdsByRoleNameWithFiltersDto;
import com.groyyo.core.user.acl.dto.UsersByFiltersRequestDto;
import com.groyyo.core.user.acl.dto.UserAccessLevelIdsByRoleNameDto;
...
import com.groyyo.core.user.acl.request.dto.CheckRoleNamesDto;
import com.groyyo.core.user.acl.request.dto.RevokeUserDeptLevelRoleRequestDto;
import com.groyyo.core.user.dto.response.UserContactDetailsResponseDto;
import com.groyyo.core.user.enums.EnumListing;
import com.groyyo.core.user.request.dto.UserStatusRequestDto;
...
public class AclUserClientApi {
	...
	public AclUserClientApi(GroyyoRestClient groyyoRestClient) {
