 ...
 * 
 */
package com.groyyo.core.user.client.api;
...
import com.groyyo.core.user.request.dto.*;
import com.groyyo.core.user.dto.*;
import com.groyyo.core.user.request.dto.UpdateUserRequestDto;
...
import com.groyyo.core.user.acl.request.dto.UserRoleSearchDto;
import com.groyyo.core.user.dto.AccessLevelRoleRequestDto;
import com.groyyo.core.user.dto.UserDto;
import com.groyyo.core.user.dto.UserManagerAndRoleDto;
import com.groyyo.core.user.dto.UserManagerProfileRequestDto;
import com.groyyo.core.user.dto.UserProfileDto;
import com.groyyo.core.user.dto.UserProfileRequestDto;
import com.groyyo.core.user.dto.UserPropertyAndProfileMappingDto;
import com.groyyo.core.user.dto.UserRoleCacheDto;
import com.groyyo.core.user.dto.response.UserContactDetailsResponseDto;
import com.groyyo.core.user.request.dto.ActiveUserRequestDto;
import com.groyyo.core.user.request.dto.AddUserRequestDto;
import com.groyyo.core.user.request.dto.UpdateUserRequestDto;
import com.groyyo.core.user.request.dto.UserRequestDto;
...
public class UserClientApi {
	...
	public UserClientApi(GroyyoRestClient groyyoRestClient) {
	...
	public ResponseDto<List<UserDeptLevelRoleNameUrlExpandedDto>> getUserRolesBe(String userUuid) {
		...
		try {
			...
			throw new GroyyoHttpException("User Service: ", exception);
		}
