...
import com.groyyo.core.base.utils.ObjectMapperUtil;
import com.groyyo.core.user.enums.OtpType;
import com.groyyo.core.user.enums.UserType;
import com.groyyo.core.user.request.dto.MobileEmailOtpRequestDto;
import com.groyyo.core.user.request.dto.MobileOtpRequestDto;
import com.groyyo.core.user.request.dto.MobileOtpValidateRequestDto;
...
public class UserOtpClientApi {
	...
	private final GroyyoRestClient restClient;

	public UserOtpClientApi(GroyyoRestClient groyyoRestClient) {
