...
import com.groyyo.core.security.constants.HeaderConstant;
...
@Log4j2
public class ThirdPartyGroyyoInterceptor extends HandlerInterceptorAdapter {

    @Value("${groyyo.client.id:client_id}")
    private String clientId;

    @Value("${groyyo.client.secret:client_secret}")
    private String clientSecret;

    @Value("${groyyo.admin.email:admin_email}")
