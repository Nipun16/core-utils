package com.groyyo.core.security.interceptor;
...
import com.groyyo.core.security.validation.RequestValidator;
...
public class AuthInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
		...
		} catch (GroyyoHttpException ex) {
			log.error("Found GroyyoHttpException: {}", ex.getMessage());
		...
		} catch (GroyyoSecurityException ex) {
			log.error("Found GroyyoSecurityException: {}", ex.getMessage());
	...
	private void returnError(HttpServletRequest request, HttpServletResponse response, GroyyoSecurityException ex) throws IOException {
