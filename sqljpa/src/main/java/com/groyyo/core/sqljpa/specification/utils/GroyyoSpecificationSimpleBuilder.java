package com.groyyo.core.sqljpa.specification.utils;
...
import com.groyyo.core.sqljpa.specification.GroyyoSpecificationSimple;

public class GroyyoSpecificationSimpleBuilder<T> {

	private final List<SearchCriteria> params;

	private final List<Specification<T>> externalSpecifications;

	public GroyyoSpecificationSimpleBuilder() {
		params = new ArrayList<>();
		externalSpecifications = new ArrayList<>();
	}

	public GroyyoSpecificationSimpleBuilder<T> with(String key, CriteriaOperation operation, Object value) {
	...
	private List<Specification<T>> addParamsToSpecification() {
		...
		for (SearchCriteria param : params) {
			specs.add(new GroyyoSpecificationSimple<T>(param));
		}
