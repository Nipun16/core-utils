...
import com.groyyo.core.base.annotation.SendExceptionToSlack;
...
public class ExceptionInterceptor {
	...
	@ExceptionHandler(GroyyoSecurityException.class)
	@ResponseStatus(value = HttpStatus.UNAUTHORIZED)
	@SendExceptionToSlack
	public <T> ResponseDto<T> handleGroyyoSecurityException(GroyyoSecurityException e) {

		String exceptionId = GroyyoUtils.generateUniqueId();
		log.error("Got GroyyoSecurityException for exceptionId: " + exceptionId, e);
	...
	@ExceptionHandler(GroyyoException.class)
	@ResponseStatus(code = HttpStatus.BAD_REQUEST)
	@SendExceptionToSlack
	public <T> ResponseDto<T> handleGroyyoException(GroyyoException e) {

		String exceptionId = getExceptionId();
		log.error("Got GroyyoException for exceptionId: {}", exceptionId, e);
	...
	@ExceptionHandler(GroyyoHttpException.class)
	@ResponseStatus(value = HttpStatus.FAILED_DEPENDENCY)
	@SendExceptionToSlack
	public <T> ResponseDto<T> handleGroyyoHttpException(GroyyoHttpException e) {

		String exceptionId = getExceptionId();
		log.error("Got GroyyoHttpException for exceptionId: {}", exceptionId, e);
	...
	private String getExceptionId() {
		String exceptionId = MDC.get(GroyyoConstants.GUID);

		if (StringUtils.isBlank(exceptionId)) {
			exceptionId = GroyyoUtils.generateUniqueId();
		}
